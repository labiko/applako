# SCRIPTS SQL POUR LE SYSTÈME FINANCIER

Exécutez ces scripts dans l'ordre dans l'interface Supabase (SQL Editor).

## SCRIPT 1: Tables principales

```sql
-- ================================================
-- SCRIPT 1: CRÉATION DES TABLES FINANCIÈRES
-- ================================================
...
-- Table 2: Détail des commissions par entreprise
...
## SCRIPT 2: Tables complémentaires
...
## SCRIPT 3: Index et optimisations
...
## SCRIPT 4: Triggers automatiques

```sql
-- ================================================
-- SCRIPT 4: TRIGGERS POUR MISE À JOUR AUTOMATIQUE
-- ================================================
...
## SCRIPT 5: Données d'initialisation

```sql
-- ================================================
-- SCRIPT 5: INITIALISATION DES DONNÉES
-- ================================================
...
2. **Exécutez les scripts dans l'ordre** (1, 2, 3, 4, 5)
3. **Vérifiez les résultats** après chaque script
4. **En cas d'erreur**, vérifiez que les tables `entreprises` et `reservations` existent déjà

⚠️ **Important**: Si vous obtenez des erreurs de références, c'est que les tables de base (`entreprises`, `reservations`) n'existent pas encore. Il faudra d'abord les créer.